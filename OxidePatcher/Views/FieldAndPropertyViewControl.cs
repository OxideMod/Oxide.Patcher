    ...
    public partial class FieldAndPropertyViewControl : UserControl
    {
        ...
        private void PopulateDetails()
        {
            ...
            if (FieldDef != null)
            {
                ...
                var qualifier = FieldDef.IsPublic ? "public" : FieldDef.IsPrivate ? "private" : "protected";
        ...
        {
            var modifier = FieldDef != null ? new Modifier(FieldDef, MainForm.rassemblydict[FieldDef.Module.Assembly]) : new Modifier(PropertyDef, MainForm.rassemblydict[PropertyDef.Module.Assembly]);
