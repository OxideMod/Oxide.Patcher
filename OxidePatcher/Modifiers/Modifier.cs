...
namespace OxidePatcher.Modifiers
{
    ...
    public sealed class ModifierSignature
    {
        ...
        {
            ModifierSignature othersig = obj as ModifierSignature;
            if (othersig == null) return false;
            if (Name != othersig.Name) return false;
            if (Exposure.Length != othersig.Exposure.Length) return false;
        ...
        public override int GetHashCode()
        {
            ...
            foreach (var exposure in Exposure)
    ...
    public class Modifier
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Views.ModifierSettingsControl CreateSettingsView()
        {
            return new Views.ModifierSettingsControl { Modifier = this };
        }
    }
}
